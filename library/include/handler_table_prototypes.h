...
#define SYSCALL_ENUM_INIT(arch_no, name, enter, post_call, exit) \
...
#define SYSCALL_HANDLER_PROTS(_arch_no, _name, _enter, _post_call, _exit) \
	SYSCALL_ENTER_PROT(_name); \
	SYSCALL_POST_CALL_PROT(_name); \
